...
### `log_manager.py` - Управление системой логов

**Описание:** Комплексный менеджер логов с возможностью анализа, ротации и очистки.
...
0 2 * * * cd /path/to/meeting_automation && python scripts/cron_log_cleanup.py
```
